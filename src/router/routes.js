...
export default [
  ...
  },
  {
    ...
    meta: {
      layout: "twocolumn", // 🆕 Troque para "twocolumn", "horizontal" ou remova o layout se o Velzon interceptar por padrão
      public: true,
      title: "Visualizar Landing Page Original"
    }
  },
  {
    path: "/artistas",
    ...
    meta: {
      layout: "public", // Ignora a barra administrativa escura do músico
      public: true,
