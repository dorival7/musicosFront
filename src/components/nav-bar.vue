        ...
        <div class="d-flex align-items-center">
          ...
          <BDropdown variant="ghost-dark" dropstart class="ms-1 dropdown"
            ...
            <BTabs nav-class="dropdown-tabs nav-tab-custom bg-primary px-2 pt-2">
              <BTab title="Alertas" class="tab-pane fade py-2 ps-2 show" id="all-noti-tab" role="tabpanel">
                  ...
                  <div class="text-reset notification-item d-block dropdown-item position-relative">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mt-0 mb-1 lh-base">Bem-vindo à área administrativa do músico!</h6>
                        <p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
                          <span><i class="mdi mdi-clock-outline"></i> Agora mesmo</span>
                        </p>
                      </div>
                    </div>
                  </div>
