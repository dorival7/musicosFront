  ...
  methods: {
    ...
    async saveSettings() {
      ...
      try {
        ...
        this.successMessage = "Configurações de logística comercial updated com sucesso!";
        this.saving = false;
      ...
      <div class="row">
        ...
        <div class="col-xl-8">
          ...
          <div class="card shadow-sm border-0">
            ...
            <div class="card-body text-start">
              ...
              <div class="form-check form-switch form-switch-md mb-4" role="switch">
        ...
        <div class="col-xl-4">
          ...
          <div class="card bg-transparent border-0 shadow-none">
            <button type="submit" class="btn btn-success btn-lg w-100 shadow-sm fw-bold" :disabled="saving">
